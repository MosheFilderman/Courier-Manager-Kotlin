...
//            Toast.makeText(this,shrd.getString("firstName", "mmm").toString(),Toast.LENGTH_SHORT).show()
//            Toast.makeText(this,shrd.getString("lastName", "nnn").toString(),Toast.LENGTH_SHORT).show()
//            Toast.makeText(this,shrd.getString("phone", "ppp").toString(),Toast.LENGTH_SHORT).show()
            if (shrd.getBoolean("connected", false)){
